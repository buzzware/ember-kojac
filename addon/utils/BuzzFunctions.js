...
bf.removeKey = function (aObject, aKey) {
	if (!aObject.hasOwnProperty(aKey))
		return undefined;
...
// find all items matching object properties
...
bf.numerate = function (aPrefix,aCount,aFirst=0) {
  let result = [];
  for (var i=aFirst;i<aCount;i++)
    result.push(aPrefix+i);
  return result;
};
